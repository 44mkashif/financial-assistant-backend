...
class Assistant:
    ...
    def answer_question(self, question, gpt_assistant_id, gpt_thread_id):
        self.client.beta.threads.messages.create(
            thread_id=gpt_thread_id, role="user", content=question
        )
        run = self.client.beta.threads.runs.create(
            thread_id=gpt_thread_id, assistant_id=gpt_assistant_id
        )
        ...
        messages = self.client.beta.threads.messages.list(thread_id=gpt_thread_id)
        return messages
